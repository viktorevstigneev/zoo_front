...
import varianOplay from "../../../img/variantOplaty.png";
      ...
      <div className="footer__container">
        ...
        <div className="footer__wrapper-middle">
          ...
          <a
            ...
            rel="noreferrer"
            target="_blank"
            href="https://www.instagram.com/zoosfera_by/"
          >
            <img src={inst} alt="" />
          </a>
          <a
            ...
            rel="noreferrer"
            target="_blank"
            href="https://vk.com/zooskazka.grodno"
          >
            <svg
          ...
          <a
            ...
            rel="noreferrer"
            target="_blank"
            href="https://www.facebook.com/zoomagazin.marsik/"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="#fff"
        ...
        <div className="footer__wrapper-right">
          <h3 className="footer__title">Контактные данные</h3>

          <a
            className="footer__link"
            href="https://www.google.ru/maps/place/%D0%BF%D1%80%D0%BE%D1%81%D0%BF.+%D0%9A%D0%BE%D1%81%D0%BC%D0%BE%D0%BD%D0%B0%D0%B2%D1%82%D0%BE%D0%B2+25,+%D0%93%D1%80%D0%BE%D0%B4%D0%BD%D0%BE,+%D0%93%D1%80%D0%BE%D0%B4%D0%BD%D0%B5%D0%BD%D1%81%D0%BA%D0%B0%D1%8F+%D0%BE%D0%B1%D0%BB%D0%B0%D1%81%D1%82%D1%8C/@53.6747027,23.8546498,17z/data=!3m1!4b1!4m5!3m4!1s0x46dfd64634c9d6bb:0x354ba8c8d17ee465!8m2!3d53.6746995!4d23.8572247?hl=ru&entry=ttu"
          >
            г.Гродно, Проспект Космонавтов, дом 25
          </a>
          <a className="footer__link" href="tel:+375339305114">
            +375(33)930-51-14
          </a>
          <a className="footer__link" href="tel:+375290532571">
            +375(29)053-25-71
          </a>
          <a className="footer__link" href="mailto:zooexpress@gmail.com">
            zooexpress@gmail.com
          </a>
        </div>
      </div>
    </footer>
